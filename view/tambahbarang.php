...
if (isset($_POST['sub'])) {
    ...
    if (empty($gambar)) {
        ...
        if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
            ...
            $sql = "INSERT INTO barang (nama, harga, jml_stok, gambar) VALUES ( '$nama_barang', $harga, $stok, '$gambar')";
            // var_dump($sql);
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <header class="card">
                        <a href="?viewBarang" class="float-right btn btn-outline-primary mt-1">Kembali ke display barang</a>
                    ...
                    <article class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-success" name="sub"> Tambah </button>
