            ...
            <div class="col-md-6">
                <div class="card">
                    <header class="card-header">
                        <h4 class="card-title mt-2">Pendaftaran</h4>
                    </header>
                    <article class="card-body">
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block" name="register"> Mendaftar </button>
                            </div>
                        </form>
                    </article>
                    <div class="border-top card-body text-center">Sudah punya akun? <a href="login.php">Masuk</a></div>
                </div>
            </div>
        </div>
    </div>
